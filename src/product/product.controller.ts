...
export class ProductController {
  ...
  @Get('/category/:id')
  findProductCategory(@Param() params): Promise<Product[]> {    
    this.productService.findProduct(params.id).then(val => console.log(val));
    return  this.productService.findProduct(params.id);
  }
